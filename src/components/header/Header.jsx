      ...
      <div className="container">
        <div className={styles.wrap}>
          ...
          <div className={styles.actions}>
            <a href="/" className={clsx(styles.icon, styles.icon_fav)}>
              <svg
                width="20"
                height="18"
                viewBox="0 0 20 18"
            ...
            <a href="/" className={clsx(styles.icon, styles.icon_folder)}>
              <svg
                width="20"
                height="18"
                viewBox="0 0 20 18"
              ...
              {collectionCount > 0 && (
                <span className={styles.counter}>{collectionCount}</span>
              )}
            </a>
          </div>
        </div>
